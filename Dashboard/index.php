...
$conn = new mysqli ($host, $dbusername, $dbpassword, $dbname);
    ...
    else
    {
      ...
      $run_query = mysqli_query($conn, $query);
        ...
        $name=$row["name"];
        $balance=$row["balance"];
        $reward_balance=$row["reward_pkr"];
        $all_time_income=$row["total_earned"];
          ...
          <div class="col-span-12 space-y-4 sm:space-y-5 lg:col-span-8 lg:space-y-6">
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-3 sm:gap-5 lg:gap-6">
              <div class="card bg-gradient-to-r from-blue-500 to-indigo-600 px-5 pb-5">
                <div>
                  <div class="ax-transparent-gridline mt-5">
                  ...
                  <p class="mt-3 text-base font-medium tracking-wide text-indigo-100">
                    ...
                    <span class="text-white"><?php echo $name;?><br><br></span>
                  </p>
...
-->                  
                  ...
                  <p class="mt-4 font-inter text-2xl font-semibold">
                    <span class="text-indigo-100">PKR</span>
                    <span class="text-white"><?php echo $all_time_income ?><br><br></span>
                  </p>
              ...
              <div class="grid grid-cols-1 gap-4 sm:col-span-2 sm:grid-cols-2 sm:gap-5 lg:gap-6">
                ...
                <div class="card justify-center p-4.5">
                  <div class="flex items-center justify-between">
                    <div>
                      ...
                      <p class="text-xs+ line-clamp-1">All Time Team</p>
                    </div>
                ...
                <div class="card justify-center p-4.5">
                  <div class="flex items-center justify-between">
                    <div>
                      ...
                      <p class="text-xs+ line-clamp-1">Left | Right</p>
                    </div>
                ...
                <div class="card justify-center p-4.5">
                  <div class="flex items-center justify-between">
                    <div>
                      <p class="text-base font-semibold text-slate-700 dark:text-navy-100">
                        <?php echo $reward_balance ?>
                      </p>
                      <p class="text-xs+ line-clamp-1">Reward </p>
                    </div>
              ...
              <div class="card px-4 pb-4 sm:px-5">
                <div class="my-3 flex h-8 items-center justify-between">
                  ...
                  <div x-data="usePopper({placement:&#39;bottom-end&#39;,offset:4})" @click.outside="isShowPopper &amp;&amp; (isShowPopper = false)" class="inline-flex">
                    ...
                    <div x-ref="popperRoot" class="popper-root" :class="isShowPopper &amp;&amp; &#39;show&#39;" style="position: fixed; inset: auto 0px 0px auto; margin: 0px; transform: translate(-855px, 194px);" data-popper-placement="top-end" data-popper-reference-hidden="" data-popper-escaped="">
...
$query = "SELECT * FROM indirect WHERE email = '$email1'";
$run_query = mysqli_query($conn, $query);
...
$query = "SELECT * FROM product_order WHERE email = '$email1'";
$run_query = mysqli_query($conn, $query);
...
?>
                  ...
                  <div class="flex cursor-pointer items-center justify-between">
                    <div class="flex items-center space-x-3.5">
                      <div class="avatar">
                        <img class="rounded-full" src="<?php echo $row["image"];?>" alt="avatar">
                      </div>
                      <div>
                        <p class="font-medium text-slate-700 dark:text-navy-100">
                          <?php 
...
$query = "SELECT * FROM direct WHERE email = '$email1'";
$run_query = mysqli_query($conn, $query);
...
$query = "SELECT * FROM bank WHERE email = '$email1'";
$run_query = mysqli_query($conn, $query);
...
$query = "SELECT * FROM statement WHERE email = '$email1' AND way='indirect'";
$run_query = mysqli_query($conn, $query);
