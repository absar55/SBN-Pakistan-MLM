...
//$product = filter_input(INPUT_POST, 'prodcut');
//$product_price = filter_input(INPUT_POST, 'product_price');
  ...
  //$buyer_email=$variable[0];
  //$product=$variable[1];
  //$product_price=$variable[2];  
...
$conn = new mysqli ($host, $dbusername, $dbpassword, $dbname);
    ...
    else
    {
      ...
      $run_query = mysqli_query($conn, $query);
        ...
        $query1 = "SELECT * FROM products WHERE product_name = '$variable[0]'";
  ...
  
      {
        ...
        $sql = "INSERT INTO product_order (email, name, phone, address, product_name, price, image)
        values ('$email1','$name','$phone','$address', '$variable[0]','$price','$image')";
        $conn->query($sql);
        ...
        <div class="main-sidebar">
          <div class="flex h-full w-full flex-col items-center border-r border-slate-150 bg-white dark:border-navy-700 dark:bg-navy-800">
            ...
            <div class="flex flex-col items-center space-y-3 py-3">
              <!-- Store -->
              <a href="Store.php" class="flex h-11 w-11 items-center justify-center rounded-lg bg-primary/10 text-primary outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:bg-navy-600 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25" x-tooltip.placement.right="&#39;Store &#39;">
...
?>
                  <button
                    ...
                    @click="$notification({text:'Request Has Been Successfully Submitted',variant:'info',position:'right-top'})"
                  >
                    Right Top
                  </button>
                  </div>
...
?>
            ...
            <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                    ...
                    <img class="hover:grow hover:shadow-lg" src="<?php echo $location ?>">
                    <div class="pt-3 flex items-center justify-between">
                        <p class=""><?php echo $product_name ?></p>
                        <p class="pt-1 text-white-900"><?php echo $price ?> PKR</p>
                    ...
                    <button onclick="window.location.href='Store.php?variable=<?php echo $product_name?>';" class="btn min-w-[7rem] bg-primary font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90" type="submit" name="submit">
                          Buy
                        </button>
