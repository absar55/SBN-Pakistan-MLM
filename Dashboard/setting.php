...
else if (isset($new_phone))
{
  ...
  $sql = "UPDATE accounts SET phone='$new_phone' where email='$email1'";
  $run_sql = mysqli_query($conn, $sql);
  $word="Phone Number";
  $key=1;
...
else if (isset($new_address))
{



  $sql = "UPDATE accounts SET address='$new_address' where email='$email1'";
  $run_sql = mysqli_query($conn, $sql);
  $word="Address";
  $key=1;
              ...
              <div class="absolute top-0 flex h-full w-full flex-col justify-between p-4 sm:p-5">
                <div class="flex justify-between">
                  <div>
                    ...
                    <p class="text-xs+ font-light">Rank:&nbsp;&nbsp;&nbsp;<?php echo $rank ?></p>
                ...
                <p class="text-xs+ font-light">Phone Number:&nbsp;&nbsp;&nbsp;<?php echo $phone ?></p>
                  <p class="text-xs+ font-light">Address:&nbsp;&nbsp;&nbsp;<?php echo $address ?></p>
...
<div style="padding-top: 50px;">
            <div class="space-y-4">
              <label class="block">
                ...
                <input class="form-input mt-1.5 w-full rounded-lg bg-slate-150 px-3 py-2 ring-primary/50 placeholder:text-slate-400 hover:bg-slate-200 focus:ring dark:bg-navy-900/90 dark:ring-accent/50 dark:placeholder:text-navy-300 dark:hover:bg-navy-900 dark:focus:bg-navy-900" placeholder="Enter New Address" type="text" pattern="[A-Za-z0-9\s,.:#-]{1,200}" title="Don't use Special Characters & max limit is 200 Letters"  name="address" required autocomplete="address">
              </label>
