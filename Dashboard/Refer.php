          ...
          <div class="flex h-full w-full flex-col items-center border-r border-slate-150 bg-white dark:border-navy-700 dark:bg-navy-800">
            ...
            <div class="is-scrollbar-hidden flex grow flex-col space-y-4 overflow-y-auto pt-6">
              ...
              <a href="index.php" class="flex h-11 w-11 items-center justify-center rounded-lg  transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25  dark:text-accent-light dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90" x-tooltip.placement.right="&#39;Dashboard&#39;">
                <img src = "../gif/home.gif" alt="" width="32px" height="32px"/>

              </a>

              <!-- Apps -->
              <a href="Refer.php" class="flex h-11 w-11 items-center justify-center rounded-lg bg-primary/10 text-primary outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:bg-navy-600 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25" x-tooltip.placement.right="&#39;Refer&#39;">
              <img src = "../gif/profile.gif" alt="" width="32px" height="32px"/>
              ...
              <img src = "../gif/dollar.gif" alt="" width="32px" height="32px"/>
              ...
              <img src = "../gif/settings.gif" alt="" width="32px" height="32px"/>
            ...
            <div class="flex flex-col items-center space-y-3 py-3">
              <!-- Store -->
              <a href="Store.php" class="flex h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25" x-tooltip.placement.right="&#39;Withdrawal &#39;">
              <img src = "../gif/supermarket.gif" alt="" width="32px" height="32px"/>
              </a>
...
?>
                  <button
                    ...
                    @click="$notification({text:'Request Has Been Submitted Successfully',variant:'info',position:'right-top'})"
                  >
                    Right Top
                  </button>
                  </div>
    ...
    document.getElementById('rightTopButton').click();
              ...
              <button @click="$store.global.isMonochromeModeEnabled = !$store.global.isMonochromeModeEnabled" class="btn h-8 w-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                <svg x-show="$store.global.isDarkModeEnabled" x-transition:enter="transition-transform duration-200 ease-out absolute origin-top" x-transition:enter-start="scale-75" x-transition:enter-end="scale-100 static" class="h-6 w-6 text-amber-400" fill="currentColor" viewBox="0 0 24 24">
                  <!-- Embedding the "color-wheel.png" icon -->
                  <image x="0" y="0" width="24" height="24" href="color-wheel.png" />
                </svg>
        ...
        <div class="grid place-items-center">
          <div class="card mt-20 w-full max-w-xl p-4 sm:p-5" x-data="pages.initCreditCard">
            ...
            <div class="flex items-center justify-between py-4">
              <p class="text-xl font-semibold text-primary dark:text-accent-light">Join New Member</p>
              <form method="POST" enctype="multipart/form-data" action="connector.php">
            ...
            <label class="block">
                <span>Kindly Make a Payment at JazzCash Account<br>03046904693<br>Shanza Bibi</span>
              </label>


            <label class="block">
                <span>Name</span>
                <input class="form-input mt-1.5 w-full rounded-lg bg-slate-150 px-3 py-2 ring-primary/50 placeholder:text-slate-400 hover:bg-slate-200 focus:ring dark:bg-navy-900/90 dark:ring-accent/50 dark:placeholder:text-navy-300 dark:hover:bg-navy-900 dark:focus:bg-navy-900" type="text" pattern="[A-Za-z0-9\s]{1,30}" title="Don't use Special Characters & max limit is 30 Letters" name="username" placeholder="Enter His/Her Name" required autocomplete="username">
              </label>
              ...
              <label class="block">
                <span>Email</span>
                <input class="form-input mt-1.5 w-full rounded-lg bg-slate-150 px-3 py-2 ring-primary/50 placeholder:text-slate-400 hover:bg-slate-200 focus:ring dark:bg-navy-900/90 dark:ring-accent/50 dark:placeholder:text-navy-300 dark:hover:bg-navy-900 dark:focus:bg-navy-900" type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" title="Like xyz@gmail.com (Small Letters)" name="new_email" placeholder="Enter New Email" required autocomplete="new_email">
              </label>

            
              <label class="block">
                <span>Password</span>
                <input class="form-input mt-1.5 w-full rounded-lg bg-slate-150 px-3 py-2 ring-primary/50 placeholder:text-slate-400 hover:bg-slate-200 focus:ring dark:bg-navy-900/90 dark:ring-accent/50 dark:placeholder:text-navy-300 dark:hover:bg-navy-900 dark:focus:bg-navy-900" type="password" pattern="[A-Za-z0-9@!_.]{8,30}" title="Don't use Space & Special Characters excpet ( @ ! _ .) & Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" name="password" placeholder="Enter New Password" required autocomplete="password">
              </label>


              <label class="block">
                <span>Confirm Password</span>
                <input class="form-input mt-1.5 w-full rounded-lg bg-slate-150 px-3 py-2 ring-primary/50 placeholder:text-slate-400 hover:bg-slate-200 focus:ring dark:bg-navy-900/90 dark:ring-accent/50 dark:placeholder:text-navy-300 dark:hover:bg-navy-900 dark:focus:bg-navy-900" type="password" pattern="[A-Za-z0-9@!_.]{8,30}" title="Don't use Space & Special Characters excpet ( @ ! _ .) & Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" name="confirm_password" placeholder="Confirm New Password" required autocomplete="confirm_password">
              </label>
             

              <label class="block">
                <span>Phone Number</span>
                <input class="form-input mt-1.5 w-full rounded-lg bg-slate-150 px-3 py-2 ring-primary/50 placeholder:text-slate-400 hover:bg-slate-200 focus:ring dark:bg-navy-900/90 dark:ring-accent/50 dark:placeholder:text-navy-300 dark:hover:bg-navy-900 dark:focus:bg-navy-900" type="tel"   pattern="+[0-9]{12}" title="Like 03012345678 with countery code" name="phone_number" placeholder="Enter His/Her Phone Number" required autocomplete="phone_number">
              </label>            

              <label class="block">
                <span>Date Of Birth</span>
                <input class="form-input mt-1.5 w-full rounded-lg bg-slate-150 px-3 py-2 ring-primary/50 placeholder:text-slate-400 hover:bg-slate-200 focus:ring dark:bg-navy-900/90 dark:ring-accent/50 dark:placeholder:text-navy-300 dark:hover:bg-navy-900 dark:focus:bg-navy-900" type="date" name="dob" placeholder="Select His/Her Date Of Birth" required autocomplete="dob">
              </label> 


              <label class="block">
                <span>Address</span>
                <input class="form-input mt-1.5 w-full rounded-lg bg-slate-150 px-3 py-2 ring-primary/50 placeholder:text-slate-400 hover:bg-slate-200 focus:ring dark:bg-navy-900/90 dark:ring-accent/50 dark:placeholder:text-navy-300 dark:hover:bg-navy-900 dark:focus:bg-navy-900" type="text" name="address" pattern="[A-Za-z0-9\s,.:#-]{1,200}" title="Don't use Special Characters & max limit is 200 Letters" placeholder="Enter His/Her Current Address " required autocomplete="address">
              </label>               
              ...
              <label class="block">
                <span>Select Sender  Bank</span>
                <select
                  class="form-input mt-1.5 w-full rounded-lg bg-slate-150 px-3 py-2 ring-primary/50 placeholder:text-slate-400 hover:bg-slate-200 focus:ring dark:bg-navy-900/90 dark:ring-accent/50 dark:placeholder:text-navy-300 dark:hover:bg-navy-900 dark:focus:bg-navy-900" name="wallet" required autocomplete="wallet">

                  <option value="" disabled selected hidden>Select Bank</option>
                  <option value="Jazzcash">Jazzcash</option>
                  <option value="Easypaisa">Easypaisa</option>
                  <option value="Other Bank">Bank</option>
              ...
              <label class="block">
                <span>Payment Sender Account Number</span>
                <input class="form-input mt-1.5 w-full rounded-lg bg-slate-150 px-3 py-2 ring-primary/50 placeholder:text-slate-400 hover:bg-slate-200 focus:ring dark:bg-navy-900/90 dark:ring-accent/50 dark:placeholder:text-navy-300 dark:hover:bg-navy-900 dark:focus:bg-navy-900" type="tel"   pattern="+[0-9]{12}" title="Like 03012345678 " name="rec_number" placeholder="Enter Payment Sender Number" required autocomplete="rec_number">
              </label>     


              <label class="block">
                <span>Transaction ID</span>
                <input class="form-input mt-1.5 w-full rounded-lg bg-slate-150 px-3 py-2 ring-primary/50 placeholder:text-slate-400 hover:bg-slate-200 focus:ring dark:bg-navy-900/90 dark:ring-accent/50 dark:placeholder:text-navy-300 dark:hover:bg-navy-900 dark:focus:bg-navy-900" type="text" pattern="[A-Za-z0-9\s]{1,20}" title="Don't use Special Characters & max limit is 20 Letters" name="tx_id" placeholder="Enter Transaction ID" required autocomplete="tx_id">
              </label>
              ...
              <label class="block">
                           ...
                           <h6 class="card-subtitle mb-2">Type=<code>&nbsp;PNG / JPG / JPEG / GIF / PDF</code><br>Max Size=<code>&nbsp; 1 MB</code></h6>
                           <input class="form-input mt-1.5 w-full rounded-lg bg-slate-150 px-3 py-2 ring-primary/50 placeholder:text-slate-400 hover:bg-slate-200 focus:ring dark:bg-navy-900/90 dark:ring-accent/50 dark:placeholder:text-navy-300 dark:hover:bg-navy-900 dark:focus:bg-navy-900" type="hidden" name="MAX_FILE_SIZE" value="1024010" />
              ...
              <label class="block">
                <input type="hidden" name="sponsor_email" value="<?php echo $email1;?>">
                </label>
                ...
                <span>Leg<br></span>
                  <input type="radio" id="age1" name="leg" value="left" required>
                  <label for="left">Left Leg</label><br>
                  <input type="radio" id="age2" name="leg" value="right">
                  <label for="right">Right Leg</label><br>  

              </label>  

              <div class="flex justify-center space-x-2 pt-4">

              <button class="btn min-w-[7rem] bg-primary font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90" type="submit" name="submit">
                  Submit
                </button>
                      </form>
