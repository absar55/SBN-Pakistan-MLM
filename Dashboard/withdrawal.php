...
?>
                  <button
                    ...
                    @click="$notification({text:'Your Request Has Been Successfully Submitted',variant:'info',position:'right-top'})"
                  >
                    Right Top
                  </button>
                  </div>
          ...
          <div class="col-span-12 grid lg:col-span-8">
            <div class="card">
              ...
              <div class="space-y-4 p-4 sm:p-5">
                ...
                <label class="block">
                <span>Select Any Microfinance Bank</span>
                <select
                  ...
                  <div class="grid grid-cols-2 gap-4">
                    ...
                    <label class="block">
                      <span>Amount</span>
                      <input class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" placeholder="Amount" type="number" min="500" name="amount" required autocomplete="amount">
                    </label>
                  </div>
                </div>
