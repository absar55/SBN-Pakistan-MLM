  ...
  else
  {
	...
	$run_query = mysqli_query($conn, $query);
  ...
  
      {
		...
		$sql = "UPDATE bank SET status='Sent' WHERE tid='$variable[0]'";
...
?>
				<tr>
					...
					?>
					<button onclick="location.href='send_withdrawal.php?var=<?php echo $tid;?>';">Send</button>
